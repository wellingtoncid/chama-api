...
class PaymentController
{
    ...
    public function subscribePlan($data, $loggedUser)
    {
        ...
        try {
            ...
            switch ($billingCycle) {
                case 'quarterly': $amount = (float)($plan['price_quarterly'] ?? $plan['price']);
                    break;
                case 'semiannual': $amount = (float)($plan['price_semiannual'] ?? $plan['price']);
                    break;
                case 'yearly': $amount = (float)($plan['price_yearly'] ?? $plan['price']);
                    break;
            }
